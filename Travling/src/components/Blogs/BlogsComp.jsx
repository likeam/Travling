...
const BlogsComp = () => {
  return (
    <>
        <div className=' dark:bg-gray-900 dark:text-white py10'>
            <section data-aos="fade-up" className='container '>
                <h1 className='pl-2 my-8 text-3xl font-bold border-1-8 border-primary/50 py2'>
                    Our Latest Blogs
                </h1>
                <div className='flex flex-col gap-3 md:flex-col md:flex-3'>
                    {
                        BlogsData.map((item) =>(
