        ...
        <div className='flex items-center justify-center h-full p-4 bg-primary/10'>
            <div className='container grid grid-cols-1 gap-4 '>
                ...
                <div
                    data-aos= "fade-up"
                    data-aos-delay = "600" 
                    className='relative p-4 space-y-4 bg-white rounded-md '>
                    <div >
                        ...
                        <input 
                            ...
                            id='destination'
                            placeholder='Dubai'
                            className='w-full p-2 my-2 bg-gray-100 rounded-full range accent-primary focus:outline-primary focus:outline outline-1'
                        />
                    </div>
                    <div>
                        <label htmlFor='destination'
                        ...
                        <input 
                            ...
                            id='destination'
                            placeholder='Dubai'
                            className='w-full  !placeholder-slate-400  p-2 my-2 bg-gray-100 rounded-full  range accent-primary focus:outline-primary focus:outline outline-1'
                        />
                    </div>
                    <div>
                ...
                <div className="flex items-center justify-center p-2 bg-gray-100 rounded-full ">
                  <input
                    ...
                    name="destination"
                    id="destination"
                    className="w-full h-2 my-2 rounded-full appearance-none bg-gradient-to-r from-primary to-secondary"
                    min="150"
                    max="10000"
                    value={priceValue}
                    step="10"
